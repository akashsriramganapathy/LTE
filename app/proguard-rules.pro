...
-keep class com.github.libretube.test.obj.** { *; }
-keep class com.github.libretube.test.api.obj.** { *; }
-keep class com.github.libretube.test.obj.update.** { *; }
...
-keep class com.github.libretube.test.ui.preferences.** { *; }
