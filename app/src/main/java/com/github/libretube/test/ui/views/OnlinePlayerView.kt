...
import com.github.libretube.test.ui.dialogs.ContentContributionDialog
...
class OnlinePlayerView(
    ...
    fun initPlayerOptions(
        ...
        binding.sbSubmit.setOnClickListener {
            val submitSegmentDialog = ContentContributionDialog()
    ...
    private fun buildSbBundleArgs(): Bundle? {
        ...
        return bundleOf(
            ...
            IntentData.videoTitle to (PlayingQueue.getCurrent()?.title ?: "")
        )
    }
