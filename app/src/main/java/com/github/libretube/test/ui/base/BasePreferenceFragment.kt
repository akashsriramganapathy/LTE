...
import com.github.libretube.test.databinding.DialogTextPreferenceBinding
...
import com.github.libretube.test.ui.preferences.EditNumberPreference
...
abstract class BasePreferenceFragment : PreferenceFragmentCompat() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        arguments?.getString("highlight_key")?.let { key ->
            view.post {
                scrollToPreference(key)
                // Optional: Flash/Highligh logic could be added here
            }
        }
    }
