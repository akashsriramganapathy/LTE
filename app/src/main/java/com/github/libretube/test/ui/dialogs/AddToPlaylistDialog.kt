...
import com.github.libretube.test.databinding.DialogAddToPlaylistBinding
...
class AddToPlaylistDialog : BottomSheetDialogFragment() {
    ...
    override fun onCreateView(
        ...
        val binding = DialogAddToPlaylistBinding.inflate(inflater, container, false)
        ...
        viewModel.uiState.observe(viewLifecycleOwner) { (lastSelectedPlaylistId, playlists, msg, saved) ->
