package com.github.libretube.test.constants
...
object PreferenceKeys {
    ...
    const val DEARROW_TITLES = "dearrow_titles"
    const val DEARROW_THUMBNAILS = "dearrow_thumbnails"
    ...
    // Debugging
    const val ENABLE_ROBUST_LOGGING = "enable_robust_logging"
    const val LOG_VIEWER_START_TIMESTAMP = "log_viewer_start_timestamp"
