...
object DashHelper {
    ...
    private data class AdapSetInfo(
        val mimeType: String,
        val formats: MutableList<StreamFormat> = mutableListOf(),
    ...
    private fun createSegmentBaseElement(document: Document, stream: StreamFormat): Element {
