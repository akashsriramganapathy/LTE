...
class DownloadPlaylistsAdapter(
     ...
     */
    private fun deletePlaylist(context: Context, position: Int, includeVideos: Boolean) {
    ...
    fun showDeleteDialog(context: Context, position: Int) {
        ...
        MaterialAlertDialogBuilder(context)
            ...
            .setPositiveButton(R.string.okay) { _, _ ->
                deletePlaylist(context, position, includeVideos)
            }
