...
import com.github.libretube.test.extensions.runSafely
...
class HomeViewModel : ViewModel() {
    ...
    private suspend fun loadBookmarks() {
        runSafely(
            ...
            ioBlock = { com.github.libretube.test.util.DeArrowUtil.deArrowPlaylistBookmarks(DatabaseHolder.Database.playlistBookmarkDao().getAll()) }
        )
    }
